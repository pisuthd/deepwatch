...
export interface RangeRow {
  ...
  /**
   * Per-row label from the source API. When present, the card uses it
   * directly instead of generating "Between $X – $Y" from the floor/cap.
   */
...
export default function RangeCard({
  ...
  // Cap to 3 rows (lowest / middle / highest) when the range ladder
  // has more than 3 bands. Kalshi's 1¢-wide buckets can produce 50+
  // bands for a popular expiry; showing all of them overflows the
  // card. For DeepBook there are only 3 bands (±1%, ±3%, ±5%) so the
  // cap is a no-op.
