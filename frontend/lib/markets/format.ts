/**
 * Display helpers. Pure, no React/Next dependencies.
 *
 * Ported from the root app's lib/markets/format.ts — the wizard +
 * comparison cards both depend on the same shape so the "apple-to-apple"
 * visual contract is identical across the two apps.
 */
 ...
 * nearest tick: floor snaps DOWN, cap snaps UP.
 *
